 ...
 * @author julia.lin
 */
public class XmlPreserver extends DefaultVisitor implements PseudolocalizationMethod {
    ...
    static {
        PseudolocalizationPipeline.registerMethodClass("xml", XmlPreserver.class);
    }
